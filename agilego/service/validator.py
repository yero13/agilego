...
class Validation:
    ...
    def __extract_value(self, cfg, match_param_values):
        ...
        return None if not res else res[cfg[Validation._CFG_KEY_EXTRACT_FIELD]]
...
class LimitExceedValidation(Validation):
    ...
    def what_if(self, obj_to_validate):
        constraint_value = self._get_value(self._cfg[Validation._CFG_KEY_CONSTRAINT], obj_to_validate)
        value_to_validate = obj_to_validate[
