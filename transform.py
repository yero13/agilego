...
if __name__ == '__main__':
    ...
    db_src = MongoDb(DbConstants.CFG_DB_JIRA).connection
    ...
    try:
        ...
        Sprint(db_src[DbConstants.JIRA_SPRINT].find_one()).to_db(db_dest)
        Team().to_db(db_dest)
        Wbs.from_records(list(db_src[DbConstants.JIRA_BACKLOG].find({}, {'_id': False}))).to_db(db_dest)
